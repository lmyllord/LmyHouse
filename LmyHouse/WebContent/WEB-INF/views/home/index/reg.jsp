...
<body>
 ...
 <div class="all">
  <div id="reg">
		 ...
		 <div class="msg">
			 <div class="panel">
			 	<div class="welcome" style="margin-bottom:20px;margin-left:20px;font-size:20px;">【欢迎注册小刘民宿！(づ￣3￣)づ╭❤～】</div>
			    <form id="user_info">
			      ...
			      <div>
			        <div class="form-group">
			          <label></label>
			          <input class="submitButton" type="button" value="提交注册信息" id="btn_reg" style="cursor:pointer;" />
			        </div>
			      </div>
