...
<body class="easyui-layout">
	...
	<div class="wu-header" data-options="region:'north',border:false,split:true">
        ...
        <img src="${admin.photo}" width="25px" height="25px" style="margin-left: 86%;margin-top: 5px;border-radius: 25px;"/>
        <div class="wu-header-right" style="float:left">
        	<p>
        		<strong class="easyui-tooltip" title="0条未读消息">${role.name}:${admin.username}</strong>，欢迎您！
        	</p>
        	<%-- <img src="${admin.photo}" width="20px" style="float:right;"/> --%>
            <p><a href="../home/index" target="_blank">网站首页</a>|<a href="logout">退出</a></p>
        </div>
    </div>
    <!-- end of header -->
    <!-- begin of sidebar -->
    	...
    	<div class="easyui-accordion" data-options="border:false,fit:true">        
   			<ul class="easyui-tree wu-side-tree">
              	<c:forEach items="${secondMenuList }" var="secondMenu">
              		<c:if test="${secondMenu.id!=5&&secondMenu.id!=67}"> 	                		
